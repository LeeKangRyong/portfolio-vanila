const PROJECT = [
  {
    ...
    BE_STACK: ["Kotlin", "Spring", "Redis", "PostgreSQL"],
    DEPLOYMENT: ["Netlify", "NCP"],
    TOOL: ["Github", "Figma", "Notion"],
    GITHUB: "https://github.com/LeeKangRyong/teamworks-fe",
    IMAGES: ["teamworks_1", "teamworks_2", "teamworks_3", "teamworks_4"],
    FUNCTION: [
    ...
    TROUBLE: [
      {
        PROBLEM:
          "PDF.js 라이브러리가 모든 페이지에 번들되어 초기 로딩 지연 발생",
        SOLUTION:
          "Code Splitting + Lazy Loading 적용 (dynamic import, ssr: false)",
        RESULT: "초기 번들 감소, 로딩 시간 개선 + 로딩 UI로 UX 향상",
      },
      {
        PROBLEM:
          "여러 Pretendard font 파일을 개별 로딩하면서 FOUT 및 Layout Shift 발생",
  ...
  },
  {
    ...
    DESCRIPTION:
      "기존 포트폴리오를 기술적 도전을 위해 VanillaJS로 재구현 및 리뉴얼",
    TOP_COLOR: "#dba231",
    ...
    TROUBLE: [
      {
        ...
        SOLUTION:
          "모달이 열릴 때 body.style.overflow = 'hidden'으로 배경 스크롤 차단",
        RESULT: "사용자 집중도 향상 및 UX 개선",
      },
      {
        PROBLEM:
          "Skill 컴포넌트의 다수 이미지를 순차 로딩하여 초기 렌더링 지연 발생",
        SOLUTION:
          "Promise.all()로 병렬 처리 전환 (map으로 Promise 배열 생성 후 일괄 await)",
  ...
  },
  {
    ...
    FE_STACK: ["React", "JavaScript", "HTML", "CSS", "Framer Motion"],
    BE_STACK: ["X"],
    DEPLOYMENT: ["Netlify"],
    TOOL: ["Github", "Figma"],
  ...
  },
  {
    ...
    DESCRIPTION:
      "RAG 기반 AI Agent '콩콩이'를 탑재한 진단, 질의응답 및 병원 추천 종합 헬스케어 앱",
    TOP_COLOR: "#dc2626",
    ...
    BE_STACK: ["Node.js", "JavaScript", "MySQL", "Prisma", "FastAPI", "Python"],
    DEPLOYMENT: ["AWS", "NGINX", "Github Actions", "Ngrok"],
    TOOL: ["Github", "Figma", "Notion"],
    GITHUB:
      "https://github.com/Prometheus-AI-Project/2025_1_Heart_Docter_kongkong",
    IMAGES: ["kong_1", "kong_2", "kong_3", "kong_4"],
    FUNCTION: [
    ...
    TROUBLE: [
      {
        PROBLEM:
          "AI 개발자들이 웹 서버 구축 경험이 없어 모델을 API로 배포하는 과정에서 막힘",
        SOLUTION:
          "FastAPI 서버, 패키지 설치, 엔드포인트 명세 가이드를 작성하여 제공",
        RESULT: "각자 독립적으로 모델 서버를 구축, 메인 서버와 성공적으로 연동",
      },
      {
        PROBLEM: "AWS GPU 서버 비용이 과도하여 AI 서버 운영이 어려웠음",
        SOLUTION:
          "로컬에서 AI 서버를 실행하고 Ngrok으로 데모데이에만 서버 연결",
        RESULT:
          "인프라 비용 100% 절감, 데모데이에 실시간 AI 기능을 원활하게 시연 성공",
      },
    ],
  },
  {
    ...
    BE_STACK: ["Node.js", "JavaScript", "MySQL", "Prisma"],
    DEPLOYMENT: ["AWS", "NGINX", "Github Actions"],
    TOOL: ["Github", "Figma", "Notion"],
    GITHUB: "https://github.com/encapmoments",
    IMAGES: ["encap_1", "encap_2", "encap_3", "encap_4"],
    FUNCTION: [
    ...
    TROUBLE: [
      {
        PROBLEM:
          "빈번한 기획 변경으로 API 응답 구조가 자주 변경되어 BE 수정 대기 필요",
        SOLUTION:
          "FE에서 우선 Mock 데이터로 구현 후, 수정된 명세서를 역으로 BE에 전달",
        RESULT: "개발 속도 유지, FE 주도로 API 구조 개선 제안 가능",
      },
      {
        PROBLEM:
          "text + 이미지까지 한 번에 만드는 시간이 openAI API로 인해 너무 오래 걸림",
